pdf(file="dripc_drip_maplot_axes.pdf", width=10, height=8)
...
plot(0,0, col="white", pch=20, xlim=c(0,20), yaxt="n", main="DRIPc vs DRIP read density", ylab="M: log2(DRIPc/DRIP)", xlab="A: 0.5 x log2(DRIPc/DRIP)", cex=0.5)
