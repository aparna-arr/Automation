...
BRCA1_RPA_SMC5<-read.delim("original_emissions.txt", header=T)
BRCA1_RPA<-read.delim("remove_SMC5_emissions.txt", header=T)
RAD51_RPA_SMC5<-read.delim("replace_BRCA1_with_RAD51_emissions.txt", header=T)
RAD51_RPA<-read.delim("replace_BRCA1_with_RAD51_remove_SMC5_emissions.txt", header=T)
...
all_data<-rbind(BRCA1_RPA_SMC5, BRCA1_RPA, RAD51_RPA_SMC5, RAD51_RPA)
